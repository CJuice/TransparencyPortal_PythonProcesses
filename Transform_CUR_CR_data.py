...
# data nathan provided in jan 2020 had "FY XXXX" format, socrata data has just number
...
def main():
    ...
    # "Agency Subobject Name","Fund Type Name","FY 2019 Budget Book Actuals","FY 2020 Budget Book Working",
    # "FY 2021 Governors Allowance"]
    ...
    source_data_file = r"OfficialData/FY 2019 Actuals through FY 2021 Allowance for Open Data Portal - Budget Figures - Data Only CUR&CR.xlsx"
    source_data_file_transformed_xlsx = r"TransformedData/FY 2019 Actuals through FY 2021 Allowance for Open Data Portal - Budget Figures - Data Only CUR&CR_TRANSFORMED.xlsx"
    fund_source_data_file_transformed_csv = r"TransformedData/FY 2019 Actuals through FY 2021 Allowance for Open Data Portal - Budget Figures - Data Only CUR&CR_TRANSFORMED.csv"
    ...
    # fy_19_only_df["Type"] = "Budget-Actual"  # Completed in FME
    ...
    # fy_20_only_df["Type"] = "Budget-Working"  # Completed in FME
    ...
    # fy_21_only_df["Type"] = "Budget-Allowance"  # Completed in FME
